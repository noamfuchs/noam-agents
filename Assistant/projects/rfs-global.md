...
name: RFS Global
status: active
goal: "Launch the first English-speaking Run For Startups cohort"
started: 2026-06
---

# RFS Global

**Goal:** Launch Run For Startups' first English-speaking ("Global"/olim) cohort, expanding beyond the Hebrew-speaking groups. Cornerstone for future global expansion (e.g. New York).
**Co-organizers:** [[dafne-bennatan]] and [[arad-fruchter]] (with [[adam-teer-run-for-startups]] on payments/exceptions, [[lev-wolf]] on cross-group program management).
**Format:** 10-week program, Wednesdays 6:30 (early AM run at Hof Migdalor → coffee + founder/CEO Q&A at FIT house). English only.
**Launch:** 2026-06-10. First speaker: [[sarel-eldor]] (founder of Key Capital, ex-Goldman Sachs Israel CEO).
...
## Program operations (from 2026-06-08, led by [[lev-wolf]])
- Weekly 15-min management Zoom sync (Lev, Adam, Shaked, Noam) + a shared weekly-sync doc (tab per meeting).
- Standardized weekly checklist: secure speakers 2–3 weeks ahead; comms cadence (Thu/Fri reminders, Fri 11:00 weekly update with location/speaker, day-of coffee order, night-before speaker reminder); post-meeting summary + photos to group, personal speaker follow-up, photos/insights to Adam.
- Member feedback: ask 3 different members after each meeting.
- Content: Naomi produces 12 videos/month (atmosphere + podcast-style CEO talks recorded with a DJI mic, subtitled as Reels); managers send member handles to Adam for tagging.
- Logistics: private internal management calendar; member + speaker invites from the official `Run for Startups` account; WhatsApp poll (not Google Docs) for coffee orders — Noam testing a simple ordering app; mandatory speaker health-declaration form (state clearly the ID is for the declaration only and not stored).
...
- Arad's stepfather — founder, $116M exit. Adam to contact.
...
- 2026-06-04 — Distinct brand for the English group (`@RFSGlobal` IG + dedicated Gmail) to separate it from the Hebrew RFS identity.
- 2026-06-04 — Accepted Zak Feingold into the cohort.
- 2026-06-03 — Alan Mekibel joins + refers 2–3 candidates (community-building partnership).
